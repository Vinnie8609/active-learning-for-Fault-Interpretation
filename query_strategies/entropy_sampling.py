...
class EntropySampling(Strategy):
    ...
    def query(self, n,seed,otherchoice,picknum,picknum_no,flag):
        ...
        data,flag_update = self.predict_prob_EntropySampling(unlabeled_data,n,seed,otherchoice,picknum,picknum_no,flag)
        # probs_sorted, idxs = probs.sort(descending=True)
        # logger = create_logger("/home/user/data/liuyue/deep-active-learning-master/deep-active-learning-master/log/","EntropySampling_idx")
